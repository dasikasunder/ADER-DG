...
module ader_dg
    ...
    real, pointer  :: Shi(:,:,:,:,:)              ! Time-averaged coefficients of source of the space-time predictor
    ...
    real, pointer  :: Fp(:,:,:,:)                 ! +ve fluctuation flux in the x-direction
    real, pointer  :: Fm(:,:,:,:)                 ! -ve fluctuation flux in the x-direction
    real, pointer  :: Gp(:,:,:,:)                 ! +ve fluctuation flux in the y-direction
    real, pointer  :: Gm(:,:,:,:)                 ! -ve fluctuation flux in the y-direction

    ! Important info and parameters concerning the governing PDE system

    type tEquations
        real :: GAMMA_S, GAMMA_G, PI_S, PI_G
    end type tEquations
